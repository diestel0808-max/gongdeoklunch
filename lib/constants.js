...
// 카테고리별 카카오 로컬 API 검색 설정
// keyword: 카카오 키워드 검색에 사용할 검색어
// groupCode: 카카오 카테고리 그룹 코드 (FD6 = 음식점, CE7 = 카페)
export const CATEGORY_SEARCH_CONFIG = [
  { category: "한식", keyword: "한식", groupCode: "FD6" },
  { category: "일식", keyword: "일식", groupCode: "FD6" },
  { category: "중식", keyword: "중식", groupCode: "FD6" },
  { category: "양식", keyword: "양식", groupCode: "FD6" },
  { category: "브런치", keyword: "브런치", groupCode: "FD6" },
  { category: "카페", keyword: "카페", groupCode: "CE7" },
];
