...
// 우리 서비스의 카테고리로 재분류하기 위한 규칙.
// 배열 순서대로 검사해서 먼저 매칭되는 카테고리로 분류합니다.
export const CATEGORY_KEYWORD_RULES = [
  {
    category: "카페",
    keywords: ["카페", "커피", "디저트", "베이커리", "제과", "브런치", "샌드위치", "샐러드"],
  },
  {
    category: "분식",
    keywords: ["분식", "떡볶이", "김밥", "순대", "튀김", "라볶이", "만두"],
  },
  { category: "베트남음식", keywords: ["베트남", "쌀국수", "월남쌈", "반미"] },
...
// 위 규칙에 걸리지 않으면 자동으로 이 카테고리로 분류됨
...
// 수집 반경 (미터 단위) - 도보 약 20분 거리 기준
export const SEARCH_RADIUS_METERS = 1500;

// 거리 필터 옵션 (도보 기준, walkMinutes 이하만 표시)
export const DISTANCE_FILTER_OPTIONS = [
  { label: "전체", maxWalkMinutes: null },
  { label: "도보 5분 이내", maxWalkMinutes: 5 },
  { label: "도보 10분 이내", maxWalkMinutes: 10 },
  { label: "도보 15분 이내", maxWalkMinutes: 15 },
  { label: "도보 20분 이내", maxWalkMinutes: 20 },
];

// 인원수 옵션 - 몇 명이 가기 좋은지
export const GROUP_SIZE_OPTIONS = ["혼자", "2명", "3~4인", "5인 이상", "단체"];

// 추천 대상 옵션 - 누구와 가기 좋은지
export const RECOMMENDED_FOR_OPTIONS = ["혼자", "동기들과", "팀원들과", "선배와", "후배와"];
